...
Download the script from [here](https://github.com/Sensing-Dev/sensing-dev-installer/releases/download/v23.10.00/installer-WinUSB.ps1) and right-click to run it in PowerShell.
